  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#0B0C10] via-[#1F2235] to-[#232946] text-white flex flex-col items-center px-4 py-10">
      ...
      <section className="w-full max-w-lg mb-16">
        ...
        {waitlistSuccess && (
          <div className="mt-6 bg-gradient-to-r from-green-900/70 via-cyan-900/60 to-purple-900/60 border border-cyan-400 text-cyan-100 p-4 rounded-lg shadow-lg flex flex-col items-center">
            <p className="font-bold text-lg mb-2">🎉 Success! Your receipt was uploaded and you’re on the waitlist.</p>
            <p className="mb-2">Watch your inbox for updates and rewards.</p>
            <div className="my-4 w-full flex flex-col items-center">
              <WalletAutoGenerator />
            </div>
            <button
              className="mt-6 px-6 py-3 rounded-lg bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-500 text-white font-extrabold shadow-lg hover:scale-105 transition"
